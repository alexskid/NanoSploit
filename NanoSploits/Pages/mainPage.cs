...
namespace NanoPages
{
    public partial class mainPage : UserControl
    {
        ...
        private void applyWalkSpeed_Click(object sender, EventArgs e)
        {
            ...
            Zorara.CoreFunctions.ExecuteScript($"game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = {wSpeedBox.Text}");
        }
        ...
        private void applyJumpPower_Click(object sender, EventArgs e)
        {
            ...
            Zorara.CoreFunctions.ExecuteScript($"game.Players.LocalPlayer.Character.Humanoid.JumpPower = {jPowerBox.Text}");
        }
        ...
        private void siticoneButton8_Click(object sender, EventArgs e)
        {
            ...
            Zorara.CoreFunctions.ExecuteScript($"game.Workspace.Gravity = {gravityBox.Text}");
        }

        private void siticoneButton1_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()");
        }

        private void siticoneButton6_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/Dex%20Explorer.txt\"))()");
        }

        private void siticoneButton2_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/Infinite%20Jump.txt\"))()");
        }

        private void siticoneButton3_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/Fly.txt\"))()");
        }

        private void siticoneButton4_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/WRD%20ESP.txt\"))()");
        }

        private void siticoneButton5_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/BTools.txt\"))()");
        }

        private void siticoneButton7_Click(object sender, EventArgs e)
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://cdn.wearedevs.net/scripts/Click%20Teleport.txt\"))()");
        }
        ...
        private void siticoneButton9_Click(object sender, EventArgs e)
        {
            try
            {
                Zorara.CoreFunctions.ExecuteScript(codeEditor1.Text);
            }
            catch (Exception ex) {
        ...
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://github.com/ltseverydayyou/uuuuuuu/blob/main/UNC%20test?raw=true\"))()");
        }
        ...
        {
            Zorara.CoreFunctions.ExecuteScript("loadstring(game:HttpGet(\"https://pastefy.app/wa3v2Vgm/raw\"))() ");
        }
    }
}
